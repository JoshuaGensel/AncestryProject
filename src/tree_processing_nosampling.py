...
def tree_processing_nosampling(inputFileName):
    ...
    keep_nodes_M = np.concatenate((nodes_M_p1, nodes_M_p2, nodes_M_p3))
    sts_M1 = ts_raw.simplify(keep_nodes_M)

    keep_nodes_Y = np.concatenate((nodes_Y_p1, nodes_Y_p2, nodes_Y_p3))
    ...
    createTreeOutput(sts_M=sts_M1, sts_Y=sts_Y1, n="all")
